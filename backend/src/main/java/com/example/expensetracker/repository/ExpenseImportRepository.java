...
public interface ExpenseImportRepository {
    ...
    ImportBatchResult importExpenseRows(String userId, String batchId, List<ParsedExpenseImportRow> rows);

    void createImportFailedRows(String batchId, List<ImportRowFailure> failedRows);
